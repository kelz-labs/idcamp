...
function addBook() {
  ...
  // logic buat modal confirm mau nambahin buku atau nggak
...
function makeBook(bookObject) {
  ...
  textStatus.innerText = `Status: ${isCompleted == true ? "Udah dibaca" : "Belum dibaca"}`; 

  // text container
  const textContainer = document.createElement("div");
  textContainer.classList.add("inner");
  textContainer.append(textId, textTitle, textAuthor, textYear, textGenre, textStatus);
  ...
  // jika buku berstatus completed, maka bakal ada tombol undo dan delete
  if (isCompleted) {
...
// fungsi nambahin buku ke selesai dibaca
...
// fungsi delete buku dari selesai dibaca
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // pas disubmit, maka tambahkan buku
  submitForm.addEventListener("submit", (e) => {
    e.preventDefault();
    addBook();
  });

  // buat ngubah text di button submit jika sudah checkbox
